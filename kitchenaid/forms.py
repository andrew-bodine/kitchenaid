...
class FoodieRegistrationForm( forms.Form ):
	...
	password = forms.CharField( widget=forms.PasswordInput( attrs={ 'placeholder': 'password', 'class': 'span6' } ) )
	password_again = forms.CharField( widget=forms.PasswordInput( attrs={ 'placeholder': 'password again', 'class': 'span6' } ) )
